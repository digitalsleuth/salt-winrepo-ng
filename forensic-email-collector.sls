...
# current = 4.4.719.1135

{% set versions = [('4.4.719.1135', '74173f2a8d16','{8E241545-FC8B-4BEB-AD91-B064B9984BA8}'),
                   ('4.3.654.1288','d8c70c01f622','{7F031501-B3A2-44E8-9C21-D12FE21CAAEE}'),
                   ('4.2.579.104','8cdeaf7626c7','{8E243BDF-FB50-44E8-A768-564F63AD22BF}'),
                   ('4.2.564.1066','bea331a9a32a','{1C5C940F-5775-432E-8A1E-A4394457C279}'),
                   ('4.2.556.1124','0add14e6ca9d','{6E18256E-75E3-4FE8-80A5-C942A338EC32}'),
...
forensic-email-collector:
  ...
  {% if version == '4.4.719.1135' %}
  '4.4.719.1136':
  {% elif version == '4.3.654.1288' %}
  '4.3.654.1289':
  {% elif version == '4.2.556.1124' %}
  '4.2.556.1125':
