...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
{% set versions = [('5.26.1', '2601', '{F25E2736-A81F-435C-8CD5-ED71AD63A2FD}', '404865'),
                   ('5.24.3', '2404', '{640132A6-C702-4B2F-96B6-562260574CAE}', '404865'),
                   ('5.22.4', '2205', '{5F58794C-C0AA-4394-ADE1-F491204395B6}', '403863')
                  ] %}

activeperl_x64:
  {% for version, build, guid, number in versions %}
  '{{ version }}':
    skip_urltest: True
